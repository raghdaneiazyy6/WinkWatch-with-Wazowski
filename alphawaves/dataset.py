...
class AlphaWaves():
    ...
    **Dataset Description**
    ...
    def _get_single_subject_data(self, subject):
        ...
        # loadmat function returns the data stored as python dictionary
        data = loadmat(filepath)

        S = data['SIGNAL'][:, 1:17]  # extracting the 16 channels data
        # stimulation of closed eye (either 0 or 1)
        stim_close = data['SIGNAL'][:, 17]
        stim_open = data['SIGNAL'][:, 18]  # same for open
        # assigning labels to the stimulation signals (1 --> closed) & (2 --> open)
    ...
    def data_path(self, subject, path=None, force_update=False,
        ...
        # download the data and return its path
